...
public class AutenticacaoViaTokenFilter extends OncePerRequestFilter {
    ...
    public AutenticacaoViaTokenFilter(ConfiguracaoDoToken configuracaoDoToken, UsuarioRepository repository) {
        this.configuracaoDoToken = configuracaoDoToken;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        boolean valido = configuracaoDoToken.isTokenValido(token);
        if (valido) {
    ...
    private void autenticarCliente(String token) {
        Long idUsuario = configuracaoDoToken.getIdUsuario(token);
